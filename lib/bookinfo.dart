...
class _BookInfoState extends State<BookInfo> {
  ...
  // Добавляем метод _toggleFavorite
  void _toggleFavorite() {
    setState(() {
      book?.isFavorite = !(book?.isFavorite ?? false); // Переключаем состояние isFavorite
    });
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _toggleFavorite, // Вызов метода _toggleFavorite
          ),
          IconButton(
